...
<section class="py-5">
    <form name="reservar" method="POST" class="border border-3 border-warning p-5 rounded-2 d-flex flex-column gap-5">
        ...
        <button type="submit" class="btn btn-warning p-3 fw-bold">Agendar</button>
